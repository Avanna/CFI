<?php
/*
 * Plugin Name: DD Sermons Widget
 * Plugin URI: http://themeforest.net/user/DDStudios/portfolio
 * Description: A widget that displays recent sermons
 * Version: 1.0
 ...
 */
add_action( 'widgets_init', 'dd_sermons_widgets' );

/*
 * Register widget.
 */
function dd_sermons_widgets() {
	register_widget( 'DD_Sermon_Widget' );
}

/*
 * Widget class.
 */
class dd_sermon_widget extends WP_Widget {

	/* ---------------------------- */
	/* -------- Widget setup -------- */
	/* ---------------------------- */
	
	function DD_Sermon_Widget() {
	
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'dd_sermon_widget', 'description' => __('A widget that displays your latest sermons.', 'localization') );

		 /* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'dd_sermon_widget' );

		/* Create the widget. */
		$this->WP_Widget( 'dd_sermon_widget', __('DD Sermons Widget','localization'), $widget_ops, $control_ops );
	}
...
<?php endif; ?>
                  ...
                  <a class="button-small rounded3 brown" href="<?php echo $viewall ?>">VIEW ALL SERMONS</a>
