<?php
/*
 * Plugin Name: DD Media Widget
 * Plugin URI: http://themeforest.net/user/DDStudios/portfolio
 * Description: A widget that displays recent medias
 * Version: 1.0
 ...
 */
add_action( 'widgets_init', 'dd_medias_widgets' );

/*
 * Register widget.
 */
function dd_medias_widgets() {
	register_widget( 'DD_Media_Widget' );
}

/*
 * Widget class.
 */
class dd_media_widget extends WP_Widget {

	/* ---------------------------- */
	/* -------- Widget setup -------- */
	/* ---------------------------- */
	
	function DD_Media_Widget() {
	
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'dd_media_widget', 'description' => __('A widget that displays your latest medias.', 'localization') );

		 /* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'dd_media_widget' );

		/* Create the widget. */
		$this->WP_Widget( 'dd_media_widget', __('DD Media Widget','localization'), $widget_ops, $control_ops );
	}
...
<?php endif; ?>
                  ...
                  <a class="button-small rounded3 brown" href="<?php echo $viewall ?>">VIEW ALL MEDIAS</a>
